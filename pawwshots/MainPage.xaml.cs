...
namespace pawwshots
{
    public sealed partial class MainPage : Page
    {
        ...
        private async Task TakePhotoAsync()
        {
            ...
            StorageFile file = await folder.GetFileAsync(localSettings.Values["soundChosen"] + ".wav");
            var soundstream = await file.OpenAsync(FileAccessMode.Read);
            sound.SetSource(soundstream, file.ContentType);
            sound.Play();
            Timer timer = new Timer(new TimerCallback(Sound_MediaEnded), null, 1000, -1);
        }

        private async void Sound_MediaEnded(object sender)
        {
        ...
        private void UpdateCaptureControls()
        {
            ...
            //Settings.IsEnabled = _isPreviewing;
            Sound.IsEnabled = _isPreviewing;
        ...
        {
            this.Frame.Navigate(typeof(SoundSelect));
        }
    }
}
